...
public class PrimeraConsulta {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // El JSON principal contiene un campo "results" que es un array de series
        JSONObject jsonResponse = new JSONObject(response.body());
        JSONArray resultsArray = jsonResponse.getJSONArray("results");

        // Muestro la cantidad de series de Dragon Ball registradas
        System.out.println("Cantidad de series de Dragon Ball registradas: " + resultsArray.length());
        // Muestro la respuesta JSON formateada
